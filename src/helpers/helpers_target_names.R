helpers_target_names <- function() {
    ...
    target_names <- list(
        ...
        #--------------------------------------------------
        # Names for doing comparison to destatis
        "static_calculated_deviations_regions_destatis" = glue::glue(
            "{static_housing_types}_calculated_deviations_regions_destatis"
        ),
        #--------------------------------------------------
        # Names for testing
