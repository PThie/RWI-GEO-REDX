...
This repository constitutes an updated version of previous reports and refers to RWI-GEO-REDX V17, which encompasses data up to November 2025.
...
Users are requested to cite the source correctly and to inform the FDZ Ruhr about publications using the data. When using the dataset RWI-GEO-REDX, please cite the data as RWI (2026): RWI-GEO-REDX: Regional Real Estate Price Index for Germany, 2008-11/2025 (V17). Version: 1. RWI – Leibniz Institute for Economic Research. Dataset. http://doi.org/10.7807/immo:redx:puf:v17. Further, we recommend citing the data description.

For more details, especially on the estimates, please refer to the [data report](https://www.rwi-essen.de/fileadmin/user_upload/RWI/FDZ/Datenbeschreibung-REDX-v17.pdf).
